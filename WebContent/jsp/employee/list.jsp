...
<tr>
<td align="right" > <a href="employee_addUI.action">添加</a></td>
</tr>
</table>
<br/>
...
<tbody>
	<s:iterator value="list" var="e">
		<tr>
			...
			<td align="center"><a href="${ pageContext.request.contextPath }/employee_editUI.action?eid=<s:property value="#e.eid" />"><img src="../images/编辑.png"/></a></a></td>
			<td align="center"><a href="${ pageContext.request.contextPath }/employee_delete.action?eid=<s:property value="#e.eid" />" />删除</td>
		</tr>
	</s:iterator>
</tbody>
</table>
...
<td align="right">
   ...
   <span>总页数：<s:property value="totalPage"/></span>&nbsp;&nbsp;
   <apan>
